...
def run_quiz_chain(_docs, topic):
    # for '_' of '_docs', streamlit knows it doesn't need to generate the signature
    #questions_response = questions_chain.invoke(docs)
    #st.write(questions_response.content)
    #formatting_response = formatting_chain.invoke(
    #    {"context": questions_response.content}
    #)
    #st.write(formatting_response.content) #we have content in AI message
...
if not docs:
    ...
    # don't need the start button because the caching is implemented
